...
public class Drive extends Subsystem {
    ...
    public void moveArcade(double speed, double rotation){
    ...
    public void moveMechanum(double direction, double magnitude, double rotation) {
    	// !!! Mechanum code goes here when drive gets it done !!!
    }
