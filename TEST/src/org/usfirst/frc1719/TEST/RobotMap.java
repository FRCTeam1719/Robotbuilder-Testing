...
public class RobotMap {
    ...
    public static void init() {
        ...
        springStringThingSolenoid = new Solenoid(1, 1);
        ...
        LiveWindow.addSensor("Sensors", "LimitSwitch SpringStringThing 1", sensorsLimitSwitchSpringStringThingExtended);
        
        sensorsLimitSwitchSpringStringThingRetracted = new DigitalInput(9);
        LiveWindow.addSensor("Sensors", "LimitSwitch SpringStringThing 2", sensorsLimitSwitchSpringStringThingRetracted);
